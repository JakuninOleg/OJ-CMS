...
const guides = [
  ...
  { title: 'Сохранить и опубликовать', text: '«Сохранить черновик» сохраняет вашу работу. «Предпросмотр» показывает результат до публикации. Когда всё готово, нажмите «Опубликовать» — изменения появятся в публичной версии.', href: '/admin/pages/home', label: 'Открыть редактор' },
...
export default function HelpPage() {
  return <>
    <PageHeader eyebrow="OJ CMS" title="Всё под рукой" description="Короткое руководство, чтобы уверенно управлять своим сайтом." />
